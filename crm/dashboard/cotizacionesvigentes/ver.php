...
$resProductoPrincipal = $serviciosReferencias->traerProductosPorIdCompleta(mysql_result($resultado,0,'refproductos'));

$lblProducto = mysql_result($resProductoPrincipal,0,'producto');

$lblDetalle = mysql_result($resProductoPrincipal,0,'detalle');

$lblEstado = mysql_result($resultado,0,'estadocotizacion');

$lblFecha = mysql_result($resultado,0,'fechacrea');
						...
						<div class="body table-responsive">
							<form class="form" id="formCountry">
								...
								<div class="row" style="padding: 5px 20px;">
									<h3><?php echo $lblProducto; ?></h3>
									<p><?php echo $lblDetalle; ?></p>
									<hr>
									<h5>Estado: <?php echo $lblEstado; ?></h5>
									<p><small>Fecha: <?php echo $lblFecha; ?></small></p>
