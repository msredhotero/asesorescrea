...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../siniestros/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Siniestros",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$eliminar = "eliminarSiniestros";

$insertar = "insertarSiniestros";
...
<script>
	$(document).ready(function(){
		...
		$('#fechasiniestro').bootstrapMaterialDatePicker({
		...
		$('#fechaaplicacion').bootstrapMaterialDatePicker({
			format: 'YYYY-MM-DD HH:mm',
			lang : 'es',
			clearButton: true,
			time: true
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=siniestros&estados='1,2'",
			"language": {
		...
		var table2 = $('#example2').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=siniestros&estados='3,4'",
			"language": {
				"emptyTable":     "No hay datos cargados",
				"info":           "Mostrar _START_ hasta _END_ del total de _TOTAL_ filas",
				"infoEmpty":      "Mostrar 0 hasta 0 del total de 0 filas",
			...
			$.ajax({
				...
				success: function(data){
					...
					if (data != '') {
						...
						$('.frmAjaxModificar #fechasiniestro').bootstrapMaterialDatePicker({
							format: 'YYYY-MM-DD HH:mm',
							lang : 'mx',
							clearButton: true,
							weekStart: 1,
						...
						$('.frmAjaxModificar #fechaaplicacion').bootstrapMaterialDatePicker({
							format: 'YYYY-MM-DD HH:mm',
							lang : 'mx',
							clearButton: true,
							weekStart: 1,
