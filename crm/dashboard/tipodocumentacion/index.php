...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../tipodocumentacion/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Tipo Documentaciones",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Tipo Documentacion";

$plural = "Tipo Documentaciones";

$eliminar = "eliminarTipodocumentaciones";

$insertar = "insertarTipodocumentaciones";
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=tipodocumentaciones",
			"language": {
