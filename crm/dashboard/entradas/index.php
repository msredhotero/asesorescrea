...
<section class="content2" style="margin-top:0px;">
						...
						<div class="body table-responsive">
							<form class="form" id="formCountry">
								...
								<div class="row" style="padding: 5px 20px;">
                                    ...
                                    <h2>Solicitud cargada y firmada.</h2>
									<div id="example1"></div>
								</div>
							</form>
							</div>
...
<script>
	$(document).ready(function(){
		PDFObject.embed('<?php echo $pathSolcitud.'/FSOLICITUDAC.pdf'; ?>', "#example1");
