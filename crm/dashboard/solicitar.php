...
//$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], 'dashboard');
//*** FIN  ****/
...
$idcliente = mysql_result($rCliente,0,0);
...
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Dashboard",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
