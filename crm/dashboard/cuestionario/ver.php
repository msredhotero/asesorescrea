								...
								<div class="row" style="padding: 5px 20px;">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 frmContrespuesta" style="display:block">
										...
										<div class="form-group input-group">
											<div class="form-line">
												<input type="text" class="form-control" id="respuesta" name="respuesta<?php echo $row['idrespuestacuestionario']; ?>" required="" aria-required="true" aria-invalid="false">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 frmContrespuesta" style="display:block">
										...
										<div class="form-group input-group">
											<div class="demo-radio-button">
												<input type="checkbox" class="filled-in" id="basic_checkbox_<?php echo $row['idrespuestacuestionario']; ?>" >
                                 	<label for="basic_checkbox_<?php echo $row['idrespuestacuestionario']; ?>"><?php echo $row['respuesta']; ?></label>
											</div>
										</div>
									</div>
									<?php
