...
$eliminar = "eliminarPreguntascuestionario";

$insertar = "insertarPreguntascuestionario";
...
$resVar2 = $serviciosReferencias->traerTiporespuesta();
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card ">
						<div class="header bg-blue">
							<h2>
								<a href='index.php' style='color:white;'>CUESTIONARIO</a> / <?php echo strtoupper($plural); ?>
							</h2>
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=preguntascuestionario&id=<?php echo $id; ?>",
			"language": {
