...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../cuentasbancarias/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Cuentas Bancarias",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Cuentas Bancarias";

$plural = "Cuentas Bancarias";

$eliminar = "eliminarCuentasbancarias";

$insertar = "insertarCuentasbancarias";
...
<script>
	$(document).ready(function(){
		...
		$("#clabeinterbancaria").attr('maxlength','18');
		$("#clabeinterbancaria").attr('minlength','18');
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=cuentasbancarias",
			"language": {
