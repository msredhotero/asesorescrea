					...
					<div class="card ">
						...
						<div class="body table-responsive">
							<form method="post" action="import.php" enctype="multipart/form-data" role="form">
								...
								<div>
									<label for="inputEmail1" class="col-lg-2 control-label">Archivo (.xlsx)*</label>
									<input type="file" name="name"  id="name" placeholder="Archivo (.xlsx)">
									<br><br>
									<button type="submit" class="btn btn-primary">Importar Datos</button>
									<br><br>
									<button type="button" class="btn btn-default" onClick="document.location.href='index.php'">Volver</button>
								</div>
							</form>
