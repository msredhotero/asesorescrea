...
$resProducto = $serviciosReferencias->traerProductosPorIdCompleta(mysql_result($resVenta,0,'refproductos'));
...
if ($_SESSION['idroll_sahilices'] == 17) {
	...
	if (($idestadopago == 8) || ($idestadopago == 5)) {
		$puedeConcluir = 0;
	}
}
	...
	<div class="container-fluid">
		<div class="row clearfix subirImagen">
			...
			<div class="row">
				...
				<?php }  ?>
				<?php //lo tengo que corregir ($i == $completos) && ?>
