				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card ">
						<div class="header bg-blue">
							<h2>
								<?php echo strtoupper($plural); ?> VRIM
							</h2>
						...
						<div class="body table-responsive">
							<form class="form" id="formCountry">
								...
								<div class="row contPagadosAux" style="padding: 5px 20px;">
									<table id="example2aux" class="display table " style="width:100%">
										<thead>
											<tr>
												<th>Cliente</th>
												<th>Nro Poliza</th>
...
<script>
	$(document).ready(function(){
		...
		$('.btnHistoricoAux').click(function() {
			$('.contActuales').hide();
			$('.contPagados').hide();
			$('.contDevueltos').hide();
			$('.contValidar').hide();
		...
		var table2aux = $('#example2aux').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=<?php echo $jstabla; ?>&estados=8",
			"order": [[ 2, "asc" ]],
			"language": {
				"emptyTable":     "No hay datos cargados",
				"info":           "Mostrar _START_ hasta _END_ del total de _TOTAL_ filas",
		...
		$("#example2aux").on("click",'.btnRecibo', function(){
			idTable =  $(this).attr("id");
			url = "subirdocumentacioni.php?id=" + idTable;
			$(location).attr('href',url);
		});
