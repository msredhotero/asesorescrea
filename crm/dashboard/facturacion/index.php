...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../facturacion/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Carrito de compras",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$datos = $serviciosComercio->traerComercioinicioFacturacion($idCliente);
//////////////////////////////////////////////  FIN de los opciones //////////////////////////
										...
										<tbody>
											<?php
												...
												while ($row = mysql_fetch_array($datos)) {
													...
													$total = substr($row['comtotal'], 0, -2).','.substr($row['comtotal'], -2);
											?>
											<tr>
												<th><?php echo $row['producto']; ?></th>
												<th><?php echo $total; ?></th>
												<th><?php echo $row['estadotransaccion']; ?></th>
												<th><?php echo $row['fechacrea']; ?></th>
												<?php
												if ($row['refestadotransaccion'] == 2) {
												?>
												<th>
													<button type="button" class="btn btn-success">
														<i class="material-icons" style="font-size:1.5em;">done</i>
														<span>Pagado</span>
													</button>
												</th>
												<?php } else { ?>
												<th>
													...
													<button type="button" class="btn btn-danger btnCancelar" id="<?php echo $row['token']; ?>">
														<i class="material-icons" style="font-size:1.5em;">remove_circle</i>
														<span>Cancelar</span>
													</button>
												</th>
												<?php } ?>
