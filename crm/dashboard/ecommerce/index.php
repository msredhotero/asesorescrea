			...
			<div class="row">
		        ...
		        <div class="card">
		          ...
		          <div class="body table-responsive">
		            ...
		            <button type="button" class="btn btn-lg btn-block btn-outline-success" onclick="window.location='new.php?producto=16'">COMPRAR</button>
		          </div>
		        </div>
			  </div>
			  <div class="col-xs-4">
		        <div class="card mb-4 box-shadow">
		          ...
		          <div class="body table-responsive">
		            ...
		            <button type="button" class="btn btn-lg btn-block btn-success" onclick="window.location='new.php?producto=16'">COMPRAR</button>
		          </div>
		        </div>
			  </div>
			  <div class="col-xs-4">
