...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Entrevista REGIONAL FINAL";

$plural = "Entrevista REGIONAL FINAL";
...
$resVar3	= $serviciosReferencias->traerEstadopostulantesPorId(6);
...
$resEntrevista = $serviciosReferencias->traerEntrevistasActivasPorPostulanteEstadoPostulante($id,6);
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=entrevistas&id=<?php echo $id; ?>&idestado=6",
			"language": {
		...
		$('.btnContinuar').click(function() {
			modificarEstadoPostulante(<?php echo $id; ?>, 999);
		});
