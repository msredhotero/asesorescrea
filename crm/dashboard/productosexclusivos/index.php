...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../productosexclusivos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Productos Exclusivos",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Productos Exclusivos";

$plural = "Productos Exclusivos";

$eliminar = "eliminarProductosexclusivos";

$insertar = "insertarProductosexclusivos";
...
$cadRef = $serviciosFunciones->devolverSelectBox($resAsesores,array(3,4,2),' ');

$resProductos = $serviciosReferencias->traerProductos();
$cadRef2 = $serviciosFunciones->devolverSelectBox($resProductos,array(1),'');
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=productosexclusivos",
			"language": {
