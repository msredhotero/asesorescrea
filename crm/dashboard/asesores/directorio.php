...
$plural = "Directorio Asesores";

$eliminar = "eliminarDirectorioasesores";

$insertar = "insertarDirectorioasesores";
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=directorio",
			"language": {
