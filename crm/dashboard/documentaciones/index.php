...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../documentaciones/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Documentaciones",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
<script>
	$(document).ready(function(){
		...
		$('#cantidadarchivos').val(1);
		$('#orden').val(1);
		$('#carpeta').val('archivo1');
