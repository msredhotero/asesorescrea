...
if (!isset($_SESSION['usua_sahilices']))
{
	...
	if ($idpagoestado != 5) {
		...
		if (move_uploaded_file($templocation, $imagen_subida)) {
			...
			$retorno = $serviciosReferencias->enviarEmail($emailReferente,utf8_decode('Se genero un pago por transferencia bancaria de financiera crea'),utf8_decode("<h4>Cliente: ".$autor."</h4><h5>Ingrese a este <a href='https://asesorescrea.com/desarrollo/crm/dashboard/listadopagos/'>link</a> para aceptarlo.</h5>"));
