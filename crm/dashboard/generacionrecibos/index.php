...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../generacionrecibos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Generacion de Recibos",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
<script>
	$(document).ready(function(){
		...
		var table5 = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=ventasrecibos",
			"language": {
