...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../comisiones/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Comisiones",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
						...
						<div class="body table-responsive">
							<form class="form" id="formCountry">
								...
								<div class="row" style="padding: 5px 20px;">
									<h4>Asesores que fueron recomendados y concluyeron el Proceso de Reclutamiento efectivamente.</h4>
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=referentescomisiones",
			"language": {
