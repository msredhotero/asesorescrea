...
$resCotizacion = $serviciosReferencias->traerVentasPorId($idventa);

$id = mysql_result($resCotizacion,0,'refcotizaciones');

$idproductoespecifico = mysql_result($resCotizacion,0,'refproductosaux');

$resVentaOriginal = $serviciosReferencias->traerRenovacionesPorVentaVieja($idventa);
...
$lblCambio	 	= array('refcotizaciones','primaneta','primatotal','foliotys','foliointerno','fechavencimientopoliza','nropoliza','refestadoventa','refproductosaux');
$lblreemplazo	= array('Venta','Prima Neta','Prima Total','Folio TYS','Folio Interno','Fecha Vencimiento de la Poliza','Nro Poliza','Estado Venta','Producto Especifico');
...
<script>
	$(document).ready(function(){
		...
		$("#fechavencimientopoliza").prop('required',true);
