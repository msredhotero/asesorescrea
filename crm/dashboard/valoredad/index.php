...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../valoredad/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Cotizacion Por Edad",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Cotizacion Por Edad";

$plural = "Cotizacion Por Edad";

$eliminar = "eliminarValoredad";

$insertar = "insertarValoredad";
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=valoredad",
			"language": {
			...
			$.ajax({
				...
				success: function(data){
					...
					if (data != '') {
						...
						$('.frmAjaxModificar #valor').number(true,2,'.','');

						$('.frmAjaxModificar .frmContfechacrea').hide();

						$('.frmModificar #vigdesde').pickadate({
							format: 'yyyy-mm-dd',
							labelMonthNext: 'Siguiente mes',
							labelMonthPrev: 'Previo mes',
							labelMonthSelect: 'Selecciona el mes del año',
						...
						$('.frmModificar #vighasta').pickadate({
							format: 'yyyy-mm-dd',
							labelMonthNext: 'Siguiente mes',
							labelMonthPrev: 'Previo mes',
							labelMonthSelect: 'Selecciona el mes del año',
