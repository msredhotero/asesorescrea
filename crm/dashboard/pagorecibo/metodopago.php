...
if ($url_real !== mysql_result($resultado,0,'accion')) {
	header('Location: ../index.php');
}

$refEstadoToken = mysql_result($resultado,0,'refestados');

$resCotizaciones = $serviciosReferencias->traerPeriodicidadventasdetallePorIdCompleto($id);

$refEstadoPago = mysql_result($resCotizaciones,0,'refestadopago');
			...
			<div class="row">
		        ...
		        <div class="card">
		          <div class="header bg-blue">
		            <h4 class="my-0 font-weight-normal">Resumen del Pedido, Pagar Recibo: <?php echo $lblProducto; ?></h4>
		          </div>
		         <div class="body table-responsive">
					...
					<?php } ?>
					<?php
						// si el estado es distinto de pendiente de pago o vencido
						} else {
							if ($refEstadoToken == 2) {
					?>
							<h3 class="display-4"><span style="color:green;"><i class="material-icons">check_box</i></span> Este proceso fue finalizado correctamente.</h3>
							<br>
							<br>
							<hr>
							<h5>Por favor pongase en contacto con uno de nuestros representantes para solicitar asesoramiento, acerca del producto</h5>
						...
						<?php } else {
							if ($refEstadoToken == 3) { ?>
								<h3 class="display-4"><span style="color:red;"><i class="material-icons">remove</i></span> Este proceso fue cancelado.</h3>
								<br>
								<br>
								<hr>
								<h5>Por favor pongase en contacto con uno de nuestros representantes para solicitar asesoramiento, acerca del producto</h5>
							...
							<?php } else { ?>
								<h3 class="display-4"><span style="color:green;"><i class="material-icons">check_box</i></span> Tu pago esta siendo procesado.</h3>
								<br>
								<br>
								<hr>
								<h5>Por favor pongase en contacto con uno de nuestros representantes para solicitar asesoramiento, acerca del producto</h5>
