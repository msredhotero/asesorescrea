...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../entrevistasoportunidades/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Entrev. Oportnidades",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
<script>
	$(document).ready(function(){
		...
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=entrevistaoportunidades",
			"language": {
