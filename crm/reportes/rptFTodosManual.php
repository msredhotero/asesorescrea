...
while ($rowD = mysql_fetch_array($documentacionesrequeridas)) {
   ...
   //die(var_dump())
   $pdf->Image('../archivos/clientes/'.$idCliente.'/'.$rowD['carpeta'].'/'.$rowD['archivo'] , 0 ,0, 100 , 0,explode('/',$rowD['type'])[1]);

}
*/
////////////////////////////// FIN DEL INE //////////////////////////////////////////

if (!file_exists('../archivos/solicitudes/cotizaciones/'.$id.'/')) {
   mkdir('../archivos/solicitudes/cotizaciones/'.$id.'/', 0777);
}

$pdf->Output( '../archivos/solicitudes/cotizaciones/'.$id.'/FSOLICITUDAC.pdf', 'F');
